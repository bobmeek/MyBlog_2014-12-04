  ...
  <body>
		...
		<div id="top"><!-- 顶部区域开始 -->
			<div class="container" style="width: 1010px; max-width:1010px; height:40px; margin: 0 auto;">
				<div class="top-left"><!-- 顶部左侧区域开始 -->
					<ul>
						<li><input type="radio" name="lang" value="中文" checked="checked" style="margin-right: 5px;" />中文</li>
						<li><input type="radio" name="lang" value="international"  style="margin-right: 5px;"/>International</li>
						<li class="desktop-hide"><a href="javascript:void(0);"  title="" class="sprit">学生</a></li>
				...
				<div class="top-right" style="height: 40px;"><!-- 顶部右侧区域开始 -->
					<a href="javascript:void(0);"><img src="resources/front_base/img/index/infoportal.png"><span class="desktophd-hide">信息门户</span></a>
				    <a href="javascript:void(0);"><img src="resources/front_base/img/index/icon-mail.png"><span class="desktophd-hide">邮件系统</span></a>
				    <a href="javascript:void(0);"><img src="resources/front_base/img/index/icon-briefcase.png"><span class="desktophd-hide">办公系统</span></a>
    ...
    <script type="text/javascript">
	    $(window).load(function() {
	        $('#slider').nivoSlider({
	        	 effect: 'fade', //指定设置：'fold(折叠), fade(褪色),  sliceDown'
	        	 animSpeed: 500, //幻灯片切换速度
	        	 pauseTime: 6000, //多久会显示每张幻灯片
	        	 controlNav: false  //取消显示1,2,3... navigation
	        });
	    });
    </script>
